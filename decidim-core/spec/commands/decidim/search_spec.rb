    ...
    describe "call" do
      ...
      describe "ordering" do
        ...
        context "when searchables are from the future" do
          let(:datetime1) { Time.zone.now + 10.seconds }
          let(:datetime2) { Time.zone.now + 20.seconds }
        ...
        context "when searchables are from the past" do
          let(:datetime1) { Time.zone.now - 1.day }
          let(:datetime2) { Time.zone.now - 2.days }
        ...
        context "when searchables are from the future and the past" do
          let(:datetime1) { Time.zone.now + 1.day }
          let(:datetime2) { Time.zone.now - 1.day }
